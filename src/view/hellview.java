...
/**
 * Die View Klasse des Spiels mit dem Lightheme.
 */
public class hellview extends PApplet implements IHellView {
    final int X_POS = 0;
    final int Y_POS = 0;
    ...
    public void drawTitleScreen() {
        super.background(color(255, 255, 0));
    ...
    public void setupGame() {
        ...
        super.textSize(27);
        super.noStroke();
        super.background(color(200, 200, 250));
    ...
    public void drawGameOver(int score) {
        super.colorMode(RGB, 255, 0, 255);
        super.background(color(255, 0, 0));
        super.textAlign(CENTER, CENTER);
        super.noStroke();
        super.textSize(64);
